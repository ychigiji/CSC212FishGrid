...
public class Fish extends WorldObject {
	 ...
	 */
	static Color[] COLORS = { Color.black, Color.green, Color.yellow, Color.blue, Color.red, Color.pink, Color.white,
			Color.orange, Color.magenta, Color.darkGray, Color.WHITE,
